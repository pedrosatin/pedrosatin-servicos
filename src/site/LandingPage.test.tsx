...
const useMockAudit = (): useAudit.UseAuditReturn => {
  ...
  const start = async (input: string): Promise<AuditResult | null> => {
    ...
    const result = {
      ...
      pagespeed: {
        ...
        field: {
          ...
          origin: true,
          overall: null,
          lcp: { p75: 100, category: 'FAST' as const },
          cls: { p75: 0, category: 'FAST' as const },
          inp: { p75: 0, category: 'FAST' as const },
        },
        screenshot: null,
        screenshotSize: null,
        opportunities: [],
